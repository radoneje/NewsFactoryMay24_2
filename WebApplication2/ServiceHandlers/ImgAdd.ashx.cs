...
namespace WebApplication2.ServiceHandlers
{
    ...
    /// </summary>
    public class ImgAdd : IHttpHandler
    {
          ...
          //  RequestContext.HttpContext.Request.g.Read
            ...
            using (Blocks.DataClassesMediaDataContext dc = new Blocks.DataClassesMediaDataContext())
            {
                ...
                try
                {
                    ...
                    {
                       // case 1:{msg="imgStarted";};break;
                        case 1:{msg="imgCreated";};break;
                        default:{msg="imgFailed";};break;
                    }
    ...
    public class ImgAddRouteHandler : IRouteHandler
    {
        public IHttpHandler GetHttpHandler(RequestContext requestContext)
        {
            return new ImgAdd() { RequestContext = requestContext }; ;
        }
    }
}