...
namespace WebApplication2.handlers
{
    ...
    /// </summary>
    public class NewsToAutoscript : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string txt = GetRtfUnicodeEscapedString("\\cf0\\protect0\\line" + NewsToText.GetAutoscript(NewsId)).Replace("\r\n", "\\line \r\n ").Replace("&nbsp;", " ").Replace("((JUMP))", "\\par\r\n\\cf1\\protect\\u9660?    \\par\r\n\\cf0\\protect0");
...
\pard\sa200\sl276\slmult1\fs26\lang9 
 " + txt + " \\par}";
    ...
    public class NewsToAutoscriptRouteHandler : IRouteHandler
    {
        public IHttpHandler GetHttpHandler(RequestContext requestContext)
        {
            return new NewsToAutoscript() { RequestContext = requestContext }; ;
        }
    }
